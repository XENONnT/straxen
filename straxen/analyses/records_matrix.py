...
@straxen.mini_analysis(requires=("records",), warn_beyond_sec=10, default_time_selection="touching")
def records_matrix(
    records,
    time_range,
    seconds_range,
...
@straxen.mini_analysis(
    requires=("raw_records",), warn_beyond_sec=3e-3, default_time_selection="touching"
)
def raw_records_matrix(
    context,
    run_id,
    raw_records,
    time_range,
