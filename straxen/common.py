...
def download_test_data():
    ...
    blob = get_resource('https://raw.githubusercontent.com/XENONnT/strax_auxiliary_files/609b492e1389369734c7d2cbabb38059f14fc05e/strax_files/strax_test_data_straxv0.9.tar' 
                        fmt='binary')
    f = io.BytesIO(blob)
