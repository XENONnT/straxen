        ...
        for type_ in self.ptypes:
            for arr_ in self.arrs:
                ...
                dtype += [
                    (
                        (
                            f"Time between 10% and 50% area quantiles for {infoline[type_]} for {arr_} PMTs [ns]",
                ...
                dtype += [
                    (
                        (
                            f"Width (in ns) of the central 50% area of the peak for {arr_} PMTs of {infoline[type_]}",
                ...
                dtype += [
                    (
                        (
                            f"Width (in ns) of the central 90% area of the peak for {arr_} PMTs of {infoline[type_]}",
            ...
            dtype += [
                (
                    (
                        f"Difference between center times of top and bottom arrays for {infoline[type_]} [ ns ]",
