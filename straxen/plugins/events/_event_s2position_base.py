    ...
    def compute(self, events):
        ...
        for p_type in ['s2', 'alt_s2']:
            ...
            with np.errstate(divide='ignore', invalid='ignore'):
                _top_pattern = (
                        _top_pattern /
                        np.max(_top_pattern, axis=1).reshape(-1, 1)
                )
