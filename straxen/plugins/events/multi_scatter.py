...
class EventInfoMS(strax.Plugin):
    ...
    def infer_dtype(self):
        dtype = strax.time_fields + [
            (('s1_sum'), np.float32, 'Sum of S1 areas in event'),
            ...
            (('s2_sum'), np.float32, 'Sum of S2 areas in event'),
            (('cs2_sum'), np.float32, 'Sum of corrected S2 areas in event'),
            ...
            (('ces_sum'), np.float32, 'Sum of the energy estimates in event'),
            (('e_charge_sum'), np.float32, 'Sum of the charge estimates in event'),
            (('x_avg'), np.float32, 'Average x position of S2s in event'),
            (('y_avg'), np.float32, 'Average y position of S2s in event'),
            (('z_obs_avg'), np.float32, 'Average observed z position of energy deposits in event'),
            (('multiplicity'), np.int32, 'Number of S2s in event'),
        ]
        return dtype
