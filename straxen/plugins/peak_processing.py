...
@strax.takes_config(
    ...
    strax.Option('check_peak_sum_area_rtol', default=None, track=False, infer_dtype=False,
...
@strax.takes_config(
    strax.Option(
        'nn_architecture', infer_dtype=False,
...
@export
@strax.takes_config(
    strax.Option('min_area_fraction', default=0.5, infer_dtype=False,
                 help='The area of competing peaks must be at least '
                      'this fraction of that of the considered peak'),
    strax.Option('nearby_window', default=int(1e7), infer_dtype=False,
                 help='Peaks starting within this time window (on either side)'
                      'in ns count as nearby.'),
    strax.Option('peak_max_proximity_time', default=int(1e8), infer_dtype=False,
