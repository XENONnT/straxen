...
class PeakShadow(strax.Plugin):
    ...
    def compute(self, peaks):
        ...
        compute_shadow_peak(peaks, split_peaks, res)
...
def compute_shadow_peak(peaks, split_peaks, res):
    if len(res):
        return _compute_shadow_peak(peaks, split_peaks, res)

@numba.njit()
def _compute_shadow_peak(peaks, split_peaks, res):
