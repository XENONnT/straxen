...
from straxen.plugins.merged_s2s.merged_s2s_vanilla import MergedS2sVanilla

export, __all__ = strax.exporter()


@export
class MergedS2sHighEnergyVanilla(MergedS2sVanilla):
    __doc__ = HE_PREAMBLE + (MergedS2sVanilla.__doc__ or "")
