...
@export
@strax.takes_config(
    strax.Option('s1_optical_map', help='S1 (x, y, z) optical/pattern map.', infer_dtype=False,
                 default='XENONnT_s1_xyz_patterns_LCE_corrected_qes_MCva43fa9b_wires.pkl'),
    strax.Option('s2_optical_map', help='S2 (x, y) optical/pattern map.', infer_dtype=False,
                 default='XENONnT_s2_xy_patterns_LCE_corrected_qes_MCva43fa9b_wires.pkl'),
    strax.Option('s1_aft_map', help='Date drive S1 area fraction top map.', infer_dtype=False,
    ...
    strax.Option('s1_min_area_pattern_fit', infer_dtype=False,
                 help='Skip EventPatternFit reconstruction if S1 area (PE) is less than this',
                 default=2),
    strax.Option('s2_min_area_pattern_fit', infer_dtype=False,
    ...
    strax.Option(name='electron_drift_time_gate', infer_dtype=False,
