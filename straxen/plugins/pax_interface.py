...
@export
@strax.takes_config(
    strax.Option('pax_raw_dir', default='/data/xenon/raw', track=False, infer_dtype=False,
                 help="Directory with raw pax datasets"),
    strax.Option('stop_after_zips', default=0, track=False, infer_dtype=False,
                 help="Convert only this many zip files. 0 = all."),
    strax.Option('events_per_chunk', default=50, track=False, infer_dtype=False,
                 help="Number of events to yield per chunk"),
    strax.Option('samples_per_record', default=strax.DEFAULT_RECORD_LENGTH,
                 track=False, infer_dtype=False,
