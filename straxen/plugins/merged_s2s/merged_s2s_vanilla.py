...
class MergedS2sVanilla(strax.OverlapWindowPlugin):
    ...
    depends_on: Tuple[str, ...] = (
        ...
        "lone_hits",
    )  # add "peaklet_positions_{DEFAULT_POSREC_ALGO}" if position check is desired. Also uncomment the position check related lines in get_merge_instructions and compute
