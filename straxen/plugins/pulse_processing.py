...
HITFINDER_OPTIONS = tuple([
    strax.Option(
    'hit_min_amplitude', track=True, infer_dtype=False,
...
HITFINDER_OPTIONS_he = tuple([
    ...
    default=('hit_thresholds_he', 'ONLINE', True), track=True, infer_dtype=False,
    help='Minimum hit amplitude in ADC counts above baseline. '
            'Specify as a tuple of length n_tpc_pmts, or a number,'
            'or a string like "pmt_commissioning_initial" which means calling'
            'hitfinder_thresholds.py'
...
@strax.takes_config(
    strax.Option('hev_gain_model',
                 default=('disabled', None), infer_dtype=False,
